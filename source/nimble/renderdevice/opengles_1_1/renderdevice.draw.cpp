...
void RenderDevice::draw(){
    ...
    // OpenGL ES 1.1 doesn't support anything but short indices
...
void RenderDevice::endFrame(){
    ...
    renderdevice::opengles_1_1::FrameBuffer *pNativeFrameBuffer = dynamic_cast<renderdevice::opengles_1_1::FrameBuffer*>(m_context.m_pFrameBuffer);
