...
#ifndef __nimble_renderdevice_opengles_1_1_texture_h__
#define __nimble_renderdevice_opengles_1_1_texture_h__
...
#define GLES11_TEXTURE_TUPLE_SET \
GLES11_TEXTURE_TUPLE(GL_RGB,                    GL_RGB,                     GL_UNSIGNED_BYTE,       sizeof(char) * 3) \
GLES11_TEXTURE_TUPLE(GL_RGB,                    GL_RGB,                     GL_UNSIGNED_SHORT,      sizeof(short) * 3) \
GLES11_TEXTURE_TUPLE(GL_RGB,                    GL_RGB,                     GL_FLOAT,               sizeof(float) * 3) \
\
GLES11_TEXTURE_TUPLE(GL_RGBA,                   GL_RGBA,                    GL_UNSIGNED_BYTE,       sizeof(char) * 4) \
GLES11_TEXTURE_TUPLE(GL_RGBA,                   GL_RGBA,                    GL_UNSIGNED_SHORT,      sizeof(short) * 4) \
GLES11_TEXTURE_TUPLE(GL_RGBA,                   GL_RGBA,                    GL_FLOAT,               sizeof(float) * 4) \
\
GLES11_TEXTURE_TUPLE(GL_BGRA,                   GL_RGBA,                    GL_UNSIGNED_BYTE,       sizeof(char) * 4) \
\
GLES11_TEXTURE_TUPLE(GL_DEPTH_COMPONENT16_OES,  GL_DEPTH_COMPONENT16_OES,   GL_UNSIGNED_SHORT,      sizeof(short) * 3)
